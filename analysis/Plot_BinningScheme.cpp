//g++ -o Plot_BinningScheme $(root-config --cflags --glibs) Plot_BinningScheme.cpp
...
void DrawBinningGrid(std::vector<double> xbins, std::vector<double> ybins,
...
int main(int argc, char** argv) {
    ...
    gStyle->SetPalette(kBird);  // or kBlueRedYellow, kRainBow
    ...
    if(h_Q2_vs_xpom) {
        ...
        h_Q2_vs_xpom->SetTitle("Q^{2} vs x_{IP}");
        ...
        // Overlay binning grid
        DrawBinningGrid(xpom_bins, Q2_bins, true,
                        h_Q2_vs_xpom->GetXaxis()->GetXmin(),
                        h_Q2_vs_xpom->GetXaxis()->GetXmax(),
                        h_Q2_vs_xpom->GetYaxis()->GetXmin(),
                        h_Q2_vs_xpom->GetYaxis()->GetXmax());

        c1->SaveAs("figs/binning_Q2_vs_xIP.png");
        c1->SaveAs("figs/binning_Q2_vs_xIP.pdf");
        delete c1;
        std::cout << "Created: figs/binning_Q2_vs_xIP.png" << std::endl;
    } else {
    ...
    if(h_Q2_vs_beta) {
        ...
        h_Q2_vs_beta->SetTitle("Q^{2} vs #beta");
        ...
        // Overlay binning grid
        DrawBinningGrid(beta_bins, Q2_bins, false,
                        h_Q2_vs_beta->GetXaxis()->GetXmin(),
                        h_Q2_vs_beta->GetXaxis()->GetXmax(),
                        h_Q2_vs_beta->GetYaxis()->GetXmin(),
                        h_Q2_vs_beta->GetYaxis()->GetXmax());

        c2->SaveAs("figs/binning_Q2_vs_beta.png");
        c2->SaveAs("figs/binning_Q2_vs_beta.pdf");
        delete c2;
        std::cout << "Created: figs/binning_Q2_vs_beta.png" << std::endl;
    } else {
    ...
    if(h_beta_vs_xpom) {
        ...
        h_beta_vs_xpom->SetTitle("#beta vs x_{IP}");
        ...
        // Overlay binning grid
        DrawBinningGrid(xpom_bins, beta_bins, true,
        ...
        c3->SaveAs("figs/binning_beta_vs_xIP.png");
        c3->SaveAs("figs/binning_beta_vs_xIP.pdf");
        delete c3;
        std::cout << "Created: figs/binning_beta_vs_xIP.png" << std::endl;
    } else {
    ...
    if(h_Q2_vs_y) {
        ...
        // Overlay binning grid
        DrawBinningGrid(y_bins, Q2_bins, false,
                        h_Q2_vs_y->GetXaxis()->GetXmin(),
                        h_Q2_vs_y->GetXaxis()->GetXmax(),
                        h_Q2_vs_y->GetYaxis()->GetXmin(),
                        h_Q2_vs_y->GetYaxis()->GetXmax());

        c4->SaveAs("figs/binning_Q2_vs_y.png");
        c4->SaveAs("figs/binning_Q2_vs_y.pdf");
        delete c4;
        std::cout << "Created: figs/binning_Q2_vs_y.png" << std::endl;
    } else {
        std::cerr << "Warning: Q2_vs_y_MC histogram not found" << std::endl;
    }

    //=========================================================================
    // Create combined 2x2 plot (like Figure 5.30)
    //=========================================================================
    ...
    c_combined->SaveAs("figs/binning_scheme_combined.png");
    c_combined->SaveAs("figs/binning_scheme_combined.pdf");
    delete c_combined;
    std::cout << "Created: figs/binning_scheme_combined.png" << std::endl;

    inputFile->Close();
    delete inputFile;

    std::cout << "\nAll binning scheme plots created successfully!" << std::endl;
